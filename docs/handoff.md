...
- When shared-login mode is enabled, MiniTickets must not continue honoring legacy local app sessions after MiniAuth identity disappears; MiniAuth account state should be the only active sign-in authority in that mode
