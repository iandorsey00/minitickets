...
- When shared-login mode is enabled, MiniTickets no longer honors legacy local app sessions after MiniAuth identity disappears; MiniAuth account state is the only active sign-in authority in that mode
